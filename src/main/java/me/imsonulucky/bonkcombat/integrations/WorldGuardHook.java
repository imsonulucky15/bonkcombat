...
public class WorldGuardHook {
    ...
    public static Collection<ProtectedRegion> getRegions(World world) {
        ...
        return manager != null ? manager.getRegions().values() : Collections.emptyList();
    }

    public static BlockVector3 getMin(ProtectedRegion region) {
        return region.getMinimumPoint();
    }

    public static BlockVector3 getMax(ProtectedRegion region) {
